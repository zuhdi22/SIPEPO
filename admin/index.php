        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="alert alert-success alert-dismissable">
             ...
             Selamat Datang Di Halaman Admin... Anda bisa mencari akun, edit, hapus dan menambahkan daftar santri
          </div>
        </div><!-- /.row -->
<!--
        <div class="row">
...
?>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter table-paginate">
                    ...
                    <td><a class="btn btn-sm btn-primary" href="absensi.php?hal=absensi&kd=<?php echo $data['nis'];?>"><i class="fa fa-absensi"></i> Bayar</a>
                        <a class="btn btn-sm btn-warning" href="edit.php?hal=edit&kd=<?php echo $data['id_santri'];?>"<i class="fa fa-absensi"></i> Edit</a></td>
                      </tr>
                      <?php
                      $no++;
                        } ?>
